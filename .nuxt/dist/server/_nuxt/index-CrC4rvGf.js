import { mergeProps, useSSRContext, defineComponent, ref, watch, computed, unref } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderClass, ssrRenderList } from "vue/server-renderer";
import "/Users/flo/muffytreen/node_modules/hookable/dist/index.mjs";
import { u as useRouter } from "../server.mjs";
import "./client-only-DJzpC_7_.js";
import "/Users/flo/muffytreen/node_modules/klona/dist/index.mjs";
import "#internal/nuxt/paths";
import "/Users/flo/muffytreen/node_modules/defu/dist/defu.mjs";
import { h as hasSupabaseConfig, s as supabase } from "./supabase-BdpgkN5e.js";
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed inset-0 z-[100] bg-black/85 backdrop-blur-md flex items-center justify-center p-4" }, _attrs))} data-v-edd76d3b><div class="bg-[#151419] border border-white/[0.08] rounded-3xl w-full max-w-md p-6 shadow-2xl flex flex-col text-white" data-v-edd76d3b><div class="flex justify-between items-center mb-5 pb-3 border-b border-white/[0.06]" data-v-edd76d3b><h3 class="text-sm font-bold uppercase tracking-wider text-white/80" data-v-edd76d3b>Crop &amp; Resize Avatar</h3><button class="text-white/40 hover:text-white p-1 hover:bg-white/[0.04] rounded-full transition-all duration-200" aria-label="Close cropper" data-v-edd76d3b><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-5 h-5" data-v-edd76d3b><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" data-v-edd76d3b></path></svg></button></div><div class="flex flex-col items-center" data-v-edd76d3b><div class="border border-white/[0.06] p-1 rounded-3xl bg-black/40 mb-5 relative flex items-center justify-center" data-v-edd76d3b><canvas${ssrRenderAttr("width", canvasWidth)}${ssrRenderAttr("height", canvasHeight)} class="rounded-2xl max-w-full" data-v-edd76d3b></canvas></div><div class="w-full space-y-4 px-2 mb-6 text-xs text-white/50" data-v-edd76d3b><div class="space-y-1" data-v-edd76d3b><div class="flex justify-between font-bold uppercase tracking-wider" data-v-edd76d3b><span data-v-edd76d3b>Zoom</span><span class="text-[#af413c]" data-v-edd76d3b>${ssrInterpolate(zoom.value.toFixed(1))}x</span></div><input type="range"${ssrRenderAttr("value", zoom.value)} min="1.0" max="3.0" step="0.1" class="w-full accent-[#af413c] cursor-pointer h-1 bg-white/[0.06] rounded appearance-none" data-v-edd76d3b></div><div class="space-y-1" data-v-edd76d3b><div class="flex justify-between font-bold uppercase tracking-wider" data-v-edd76d3b><span data-v-edd76d3b>Horizontal Shift</span></div><input type="range"${ssrRenderAttr("value", offsetX.value)} min="-100" max="100" step="1" class="w-full accent-[#af413c] cursor-pointer h-1 bg-white/[0.06] rounded appearance-none" data-v-edd76d3b></div><div class="space-y-1" data-v-edd76d3b><div class="flex justify-between font-bold uppercase tracking-wider" data-v-edd76d3b><span data-v-edd76d3b>Vertical Shift</span></div><input type="range"${ssrRenderAttr("value", offsetY.value)} min="-100" max="100" step="1" class="w-full accent-[#af413c] cursor-pointer h-1 bg-white/[0.06] rounded appearance-none" data-v-edd76d3b></div></div><div class="flex gap-3 w-full border-t border-white/[0.06] pt-4" data-v-edd76d3b><button class="flex-1 bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.06] hover:border-white/10 text-white/80 hover:text-white rounded-xl text-xs font-bold transition-all py-2.5" data-v-edd76d3b> Cancel </button><button${ssrIncludeBooleanAttr(rendering.value) ? " disabled" : ""} class="flex-1 bg-[#af413c] hover:bg-[#c94b45] text-white rounded-xl text-xs font-bold transition-all py-2.5 active:scale-95 disabled:opacity-50" data-v-edd76d3b> Save Crop (1024x1024) </button></div></div></div></div>`);
    };
  }
});
...
const AvatarUploader = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-edd76d3b"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="text-[10px] font-bold text-white/20">#${ssrInterpolate(__props.idx + 1)}</span><input type="text"${ssrRenderAttr("value", __props.link.title)} className="bg-transparent border-b border-transparent hover:border-white/20 focus:border-[#af413c]/50 text-sm font-bold !text-white outline-none pb-0.5 flex-1 w-full" placeholder="Link Title"${ssrIncludeBooleanAttr(__props.isDragActive) ? " disabled" : ""}></div><div class="flex items-center gap-1.5"><button class="${ssrRenderClass([
        ...
        __props.link.is_active ?? true ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : "bg-white/[0.04] border-white/[0.06] text-white/30"
      ])}"${ssrIncludeBooleanAttr(__props.isDragActive) ? " disabled" : ""}>`);
      if (__props.link.is_active ?? true) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (!mounted.value || loading.value) {
        ...
        _push(ssrRenderComponent(_sfc_main$1, {
          ...
          itemName: deleteTargetIndex.value !== null ? links.value[deleteTargetIndex.value]?.title || "this link" : "",
...
//# sourceMappingURL=index-CrC4rvGf.js.map
