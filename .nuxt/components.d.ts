...
export const AdminLinksManager: typeof import("../components/admin/LinksManager.vue")['default']
export const AdminProfileEditor: typeof import("../components/admin/ProfileEditor.vue")['default']
export const AdminSettingsEditor: typeof import("../components/admin/SettingsEditor.vue")['default']
export const AdminSidebar: typeof import("../components/admin/Sidebar.vue")['default']
export const AdminSocialsEditor: typeof import("../components/admin/SocialsEditor.vue")['default']
...
export const LazyAdminLinksManager: LazyComponent<typeof import("../components/admin/LinksManager.vue")['default']>
export const LazyAdminProfileEditor: LazyComponent<typeof import("../components/admin/ProfileEditor.vue")['default']>
export const LazyAdminSettingsEditor: LazyComponent<typeof import("../components/admin/SettingsEditor.vue")['default']>
export const LazyAdminSidebar: LazyComponent<typeof import("../components/admin/Sidebar.vue")['default']>
export const LazyAdminSocialsEditor: LazyComponent<typeof import("../components/admin/SocialsEditor.vue")['default']>
