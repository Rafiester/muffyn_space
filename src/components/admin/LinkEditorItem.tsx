      ...
      <div className="flex items-center justify-between pb-3 border-b border-white/[0.04] gap-4">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className={`px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider rounded-md border transition-all flex items-center gap-1 ${
              (link.is_active ?? true)
          ...
          <button
            ...
            className="px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider rounded-md border bg-rose-500/10 border-rose-500/20 hover:bg-rose-500/20 text-rose-400 transition-all flex items-center gap-1"
            title="Delete Link"
            disabled={isDragActive}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-2.5 h-2.5">
