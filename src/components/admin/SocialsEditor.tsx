  ...
  return (
    <div className="bg-[#1e1d23]/80 border border-white/[0.04] p-6 rounded-2xl backdrop-blur-sm mt-6">
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-[10px] font-bold uppercase tracking-wider text-white/25 mb-2" htmlFor="social-github">GitHub URL</label>
          <input
            id="social-github"
            type="text"
        ...
        <div>
          <label className="block text-[10px] font-bold uppercase tracking-wider text-white/25 mb-2" htmlFor="social-twitter">Twitter URL</label>
          <input
            id="social-twitter"
            type="text"
        ...
        <div>
          <label className="block text-[10px] font-bold uppercase tracking-wider text-white/25 mb-2" htmlFor="social-linkedin">LinkedIn URL</label>
          <input
            id="social-linkedin"
            type="text"
        ...
        <div>
          <label className="block text-[10px] font-bold uppercase tracking-wider text-white/25 mb-2" htmlFor="social-email">Email Address</label>
          <input
            id="social-email"
            type="email"
            value={socials.email}
